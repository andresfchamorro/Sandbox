...
var ZonalStatsRef = function(feature) {
  ...
  for (var i = 0; i < 12; i++) {
    ...
    var nameAll_mean = ee.String("RainAllRef_mean__").cat("_").cat(month);
    var nameCrop_mean = ee.String("RainCropRef_mean__").cat("_").cat(month);
    var namePas_mean = ee.String("RainPasRef_mean__").cat("_").cat(month);
