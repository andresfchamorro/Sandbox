...
// var chirpsCol = ee.ImageCollection(CHIRPS_PENTAD).select('precipitation');
...
// var maskedCHIRPS_allref = chirpsCol;
// var maskedCHIRPS_allref = chirpsCol.map(multCol);
// var maskedCHIRPS_cropref = chirpsCol.map(maskCol);
